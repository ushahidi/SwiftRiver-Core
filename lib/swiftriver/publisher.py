"""
Producer threads that consume jobs from an in memory Queue and publish them to the MQ.
"""
...
class DropPublisher(Publisher):
    ...
    def __init__(self, mq_host):
         Publisher.__init__(self, "Drop Publisher", mq_host, queue_name='DROPLET_QUEUE')